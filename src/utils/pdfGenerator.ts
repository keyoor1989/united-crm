  ...
  try {
    const docDefinition: TDocumentDefinitions = {
      ...
      content: [
        ...
        { text: quotation.terms || '', style: 'termsList', margin: [0, 5, 0, 0] },
        
        // Notes if any
        quotation.notes ? { text: 'Notes', style: 'termsHeader' } : {},
        quotation.notes ? { text: quotation.notes, style: 'termsList' } : {},
        
        // Thank you note
        { text: 'Thank you for choosing United Copier!', style: 'footer', margin: [0, 20, 0, 0] }
      ],
      defaultStyle: {
        font: 'Roboto'
      },
  ...
  try {
    const docDefinition: TDocumentDefinitions = {
      ...
      content: [
        ...
        { text: order.terms || '', style: 'termsList', margin: [0, 5, 0, 0] },
        
        // Notes if any
        order.notes ? { text: 'Notes', style: 'termsHeader' } : {},
        order.notes ? { text: order.notes, style: 'termsList' } : {},
